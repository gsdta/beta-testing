...
|-------|----------|---------|-------------|
| `superadmin-uat@gsdta.org` | `UatTest123!` | Super Admin | Full system access, feature flags, admin management |
| `teacher-uat@gsdta.org` | `UatTest123!` | Teacher | Teacher portal, attendance, gradebook |
| `parent1-uat@gsdta.org` | `UatTest123!` | Parent | Parent portal with 5 children (UAT Student 1-5) |
| `parent2-uat@gsdta.org` | `UatTest123!` | Parent | Parent portal with 5 children (UAT Student 6-10) |
| `parent-teacher-uat@gsdta.org` | `UatTest123!` | Parent + Teacher | Multi-role: can switch between parent and teacher |
| `parent-admin-uat@gsdta.org` | `UatTest123!` | Parent + Admin | Multi-role: parent and admin access |
| `teacher-admin-uat@gsdta.org` | `UatTest123!` | Teacher + Admin | Multi-role: teacher and admin access |
| `allroles-uat@gsdta.org` | `UatTest123!` | All Roles | Has all 4 roles for testing role switching |
...
5. **Data Isolation**: QA environment data is completely separate from production. Feel free to create, modify, or delete test data.
